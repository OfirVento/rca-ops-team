                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        filter === f
                                            ...
                                            : "bg-white border border-slate-200 text-slate-500 hover:border-indigo-600/20 hover:text-indigo-600"
                                    )}
                                >
                                    {f}
                                </button>
                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="bg-white border border-slate-200 rounded-2xl py-2.5 pl-11 pr-4 text-sm font-semibold focus:outline-none focus:ring-4 focus:ring-indigo-600/10 transition-all w-64 shadow-sm"
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {filteredAreaSets.map((rs) => (
                                    <motion.div
                                        key={rs.id}
                                        layoutId={rs.id}
                                        className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:border-indigo-600/20 hover:shadow-md transition-all group flex items-center justify-between"
                                    >
                                        <div className="flex items-center gap-6 flex-1">
                                            <div className="h-12 w-12 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors shrink-0">
                                        ...
                                        <div className="flex items-center gap-3 shrink-0 ml-8">
                                            <button
                                                ...
                                                className="h-10 px-6 rounded-2xl bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-sm"
                                            >
                                                Open Detail
                                            </button>
                                                ...
                                                <div key={rs.id} className="bg-white rounded-2xl p-5 border border-amber-200/50 shadow-sm flex items-center justify-between group">
                                                    <div>
                                                        ...
                                                        <div className="flex items-center gap-2 mt-3">
                                                            ...
                                                            <p className="text-[9px] font-bold text-slate-400 uppercase">Replaced by <span className="text-indigo-600 font-black">V4 Global Engine</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ))}
